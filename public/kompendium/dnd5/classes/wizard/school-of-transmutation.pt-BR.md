...
## Transmutação Instruída [#transmutation-savant]

Quando você escolhe essa escola no 2° nível, o ouro e o tempo que você precisa gastar para copiar uma magia da escola de transmutação em seu grimório é reduzido à metade.

## Alquimia Menor [#minor-alchemy]
...
## Pedra de Transmutador [#transmuters-stone]
...
No 10° nível, você adiciona a magia [metamorfose](_/kompendium/dnd5/spells?name=metamorfose) ao seu grimório, se você ainda não a possuir. Você pode conjurar _metamorfose_ sem gastar um espaço de magia. Quando o fizer, você só pode escolher a si mesmo como alvo e se transforma em uma besta com nível de desafio 1 ou menor.

Quando você conjurar _metamorfose_ dessa forma, você não poderá fazê-lo novamente até terminar um descanso curto ou longo, apesar de ainda poder conjurá-la normalmente usando espaços de magia disponíveis.
