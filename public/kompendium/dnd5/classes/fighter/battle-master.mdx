...
**Maneuvers.** You learn three maneuvers of your choice, which are detailed under <Link href="#maneuvers">Manobras</Link> below. Many maneuvers enhance an attack in some way. You can use only one maneuver per attack.
