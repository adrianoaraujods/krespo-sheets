...
Yours is a path that seeks attunement with the natural world, giving you a kinship with beasts. At 3rd level when you adopt this path, you gain the ability to cast the [beast sense](_/kompendium/dnd5/spells?name=beast+sense) and [speak with animals](_/kompendium/dnd5/spells?name=speak+with+animals) spells, but only as rituals.
...
At 10th level, you can cast the [commune with nature](_/kompendium/dnd5/spells?name=commune+with+nature) spell, but only as a ritual. When you do so, a spiritual version of one of the animals you chose for Totem Spirit or Aspect of the Beast appears to you to convey the information you seek.
