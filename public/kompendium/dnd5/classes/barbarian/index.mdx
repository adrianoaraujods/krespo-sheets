...
- When you make a melee weapon attack using Strength, you gain a bonus to the damage roll that increases as you gain levels as a barbarian, as shown in the Rage Damage column of the <Link href="#barbarian-table">Barbarian table</Link>.
...
Once you have raged the number of times shown for your barbarian level in the Rages column of the <Link href="#barbarian-table">Barbarian table</Link>, you must finish a long rest before you can rage again.
