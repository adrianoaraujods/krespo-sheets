...
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| 1°               | [mãos flamejantes](/kompendium/dnd5/spells?name=mãos+flamejantes), [fogo das fadas](/kompendium/dnd5/spells?name=fogo+das+fadas) |
| 3°               | [esfera flamejante](/kompendium/dnd5/spells?name=esfera+flamejante), [raio ardente](/kompendium/dnd5/spells?name=raio+ardente)   |
| 5°               | [luz do dia](/kompendium/dnd5/spells?name=luz+do+dia), [bola de+ fogo](/kompendium/dnd5/spells?name=bola+de+fogo)                |
| 7°               | [guardião da fé](/kompendium/dnd5/spells?name=guardião+da+fé), [muralha de fogo](/kompendium/dnd5/spells?name=muralha+de+fogo)   |
| 9°               | [coluna de chamas](/kompendium/dnd5/spells?name=coluna+de+chamas), [vidência](/kompendium/dnd5/spells?name=vidência)             |

## Truque Adicional [#bonus-cantrip]

Quando você escolhe esse domínio no 1° nível, você ganha o truque [luz](/kompendium/dnd5/spells?name=luz) se você ainda não o conhecia.
...
A partir do 2° nível, você pode usar seu [Canalizar Divindade](/kompendium/dnd5/classes/cleric#channel-divinity) para criar uma explosão de luz solar, banindo a escuridão e causando dano radiante aos inimigos.
...
No 6° nível, você também pode utilizar sua característica <Link href="#warding-flare">Labareda Protetora</Link> quando uma criatura que você possa ver a até 9 metros atacar outra criatura diferente de você.
