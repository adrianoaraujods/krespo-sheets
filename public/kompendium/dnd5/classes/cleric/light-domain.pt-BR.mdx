---
title: Domínio da Luz
---

Os deuses da luz - como Helm, Lathander, Pholtus, Branchala, a Chama Prateada, Belenus, Apolo e ReHorakhty - promovem os ideias do renascimento e renovação, verdade, vigilância e beleza, muitas vezes usando o símbolo do sol. Alguns desses deuses são retratados como o próprio sol ou como um cocheiro que carrega o sol através do céu. Outros são sentinelas incansáveis cujos olhos penetram cada sombra e veem através de cada enganação. Alguns são divindades da beleza e arte que ensinam que a arte é o veículo para o aprimoramento da alma. Clérigos de um deus da luz são almas esclarecidas infundidas com radiação e o poder divino da visão do discernimento, conhecidos por afastar as mentiras e incineras a escuridão.

## Magias do Domínio da Luz [#light-domain-spells]

| Nível de Clérigo | Magias                                                                                                                             |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| 1°               | [mãos flamejantes](_/kompendium/dnd5/spells?name=mãos+flamejantes), [fogo das fadas](_/kompendium/dnd5/spells?name=fogo+das+fadas) |
| 3°               | [esfera flamejante](_/kompendium/dnd5/spells?name=esfera+flamejante), [raio ardente](_/kompendium/dnd5/spells?name=raio+ardente)   |
| 5°               | [luz do dia](_/kompendium/dnd5/spells?name=luz+do+dia), [bola de+ fogo](_/kompendium/dnd5/spells?name=bola+de+fogo)                |
| 7°               | [guardião da fé](_/kompendium/dnd5/spells?name=guardião+da+fé), [muralha de fogo](_/kompendium/dnd5/spells?name=muralha+de+fogo)   |
| 9°               | [coluna de chamas](_/kompendium/dnd5/spells?name=coluna+de+chamas), [vidência](_/kompendium/dnd5/spells?name=vidência)             |

## Truque Adicional [#bonus-cantrip]

Quando você escolhe esse domínio no 1° nível, você ganha o truque [luz](_/kompendium/dnd5/spells?name=luz) se você ainda não o conhecia.

## Labareda Protetora [#warding-flare]
...
## Canalizar Divindade: Radiação do Amanhecer [#channel-divinity:radiance-of-the-dawn]

A partir do 2° nível, você pode usar seu [Canalizar Divindade](_/kompendium/dnd5/classes/cleric#channel-divinity) para criar uma explosão de luz solar, banindo a escuridão e causando dano radiante aos inimigos.
...
## Labareda Aprimorada [#improved-flare]

No 6° nível, você também pode utilizar sua característica [Labareda Protetora](#warding-flare) quando uma criatura que você possa ver a até 9 metros atacar outra criatura diferente de você.

## Conjuração Poderosa [#potentt-spellcasting]

A partir do 8° nível, você adiciona seu modificador de Sabedoria no dano causado por qualquer truque de clérigo.

## Coroa de Luz [#corona-of-light]
