...
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| 1°               | [auxílio divino](_/kompendium/dnd5/spells?name=auxílio+divino), [escudo da fé](_/kompendium/dnd5/spells?name=escudo+da+fé)                   |
| 3°               | [arma mágica](_/kompendium/dnd5/spells?name=arma+mágica), [arma espiritual](_/kompendium/dnd5/spells?name=arma+espiritual)                   |
| 5°               | [manto do cruzado](_/kompendium/dnd5/spells?name=manto+do+cruzado), [espíritos guardiões](_/kompendium/dnd5/spells?name=espíritos+guardiões) |
| 7°               | [movimentação livre](_/kompendium/dnd5/spells?name=movimentação+livre), [pele de pedra](_/kompendium/dnd5/spells?name=pele+de+pedra)         |
| 9°               | [coluna de chamas](_/kompendium/dnd5/spells?name=coluna+de+chamas), [imobilizar monstro](_/kompendium/dnd5/spells?name=imobilizar+monstro)   |
