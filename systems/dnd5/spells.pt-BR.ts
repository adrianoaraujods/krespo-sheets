...
export const SPELLS: Spell[] = [
  ...
  },
  {
    ...
    upcastDescription:
      "Quando você conjurar essa magia usando um espaço de magia de 2º nível ou superior, jogue 2d8 adicionais para cada nível do espaço acima do 1°.",
    source: "players-handbook",
    casters: ["bard", "sorcerer", "wizard"],
    type: ["utility"],
  },
  ...
  },
  {
    ...
    upcastDescription:
      "Quando você conjura essa magia usando um espaço de magia de 3° nível ou superior, o dano aumenta em 1d8 para cada nível do espaço acima do 2°",
  },
  {
    name: "Bolha de ar",
    ...
    upcastDescription:
      "Quando você conjura essa magia usando um espaço de magia de 3° nível ou superior, você pode criar dois globos de ar frescos adicionais para cada espaço acima do 2°",
  },
  {
  ...
  },
  {
    ...
    upcastDescription:
      "Quando você conjura essa magia usando um espaço de magia de 3° nível ou superior, o dano aumenta em 1d6 para cada nível do espaço de magia acima do 2°",
  },
  {
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3º nível ou superior, o dano aumenta em 1d8 para cada nível de espaço acima do 2º.",
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "Familiares invocados por essa magia podem se comunicar telepaticamente com você e compartilhar seus sentidos visuais ou auditivos enquanto eles estiverem dentro de 1 milha de você(1,6km)",
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3º nível ou superior, você conjura um familiar adicional para cada nível do espaço de magia acima do 2°",
  },
  {
    name: "Auxilio da Sorte",
    ...
    upcastDescription:
      "Quando você conjura este feitiço usando um espaço de magia de 3º nível ou superior, você pode escolher uma criatura adicional para cada nível de espaço acima do 2º.",
  },
  {
    name: "Dom da Fala",
    ...
    type: ["utility"],
    casters: ["wizard", "bard"],
    castingTime: "1 Reação, feita quando focê fala com outra criatura",
    range: "Pessoal",
    components: {
      v: true,
      s: true,
  ...
  },
  {
    ...
    upcastDescription:
      "Quando você lança este feitiço usando um espaço de magia de 3º nível ou superior, a cura aumenta em 1d6 para cada nível de espaço acima do 2º",
  },
  {
    name: "Objeto Imóvel",
    ...
    upcastDescription:
      "Se você conjurar esta magia usando um espaço de magia de 4º ou 5º nível, a CD para mover o objeto aumenta em 5, ele pode suportar até 3.600 kg de peso e a duração aumenta para 24 horas. Se você conjurar esta magia usando um espaço de magia de 6º nível ou superior, a CD para mover o objeto aumenta em 10, ele pode suportar até 9.000 kg de peso e o efeito é permanente até ser dissipado.",
  },
  {
  ...
  },
  {
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3° nível ou superior, o dano aumenta por 1d6 para cada nível do espaço de magia acima de 2º.",
  },
  {
  ...
  },
  {
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3° nível ou superior, o dano aumenta por 1d8 para cada nível do espaço de magia acima de 2º.",
  },
  {
    name: "Lâmina Sombria",
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3° ou 4° nível, o dano aumenta para 3d8. Quando você a conjura usando um espaço de magia de 5º ou 6° nível, o dano aumenta para 4d8. Quando você conjura usando um espaço de magia de 7º nível ou superior, o dano aumenta para 5d8.",
  },
  {
  ...
  },
  {
    ...
    duration: "Instantâneo",
    description: [
      "Você faz uma rajada de cartas espectrais em um conde de 4,5m. Cada criatura na área deve fazer um teste de resistência de destreza. Em uma falha, a criatura sofre 2d10 de dano de força e a condição cega até o final do próximo turno dela. Em um sucesso, ela sofre apenas metade do dano.",
    ],
    upcastDescription:
      "Quando você conjura essa magia usando um espaço de magia de 3° nível ou superior, o dano aumenta em 1d10 para cada nível do espaço acima do 2°.",
  },
  {
    name: "Invocar Besta",
    ...
    description: [
      ...
      "Força (18), destreza(11), Constituição(16), inteligencia(4), sabedoria(14), carisma(5)",
      ...
      "Estraçalhar. Ataque com arma corpo a corpo a corpo: Seu modificador de ataque com magia para acertar, alcance de 1,5m, um alvo. Em um acerto: 1d8+4 + o nível da magia como dano perfurante",
    ],
    upcastDescription:
      "Ao conjurar essa magia com um espaço de 3° nível ou superior, o nível da magia aumenta conforme indicado no bloco de estatistica",
  },
  {
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3º nível ou superior, você pode mirar em uma criatura adicional para cada nível de espaço acima do 2º. As criaturas devem estar dentro de 9 metros umas das outras quando você as mira.",
  },
  {
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3º nível ou superior, o alcance da magia aumenta em 9 metros para cada nível de espaço acima do 2º.",
  },
  {
    ...
    description: [
      ...
      "A magia pode penetrar a maioria das barreiras, mas é bloqueada por 30 cm de pedra, 2,5 cm de metal comum, uma folha fina de chumbo ou 1 metro de madeira ou terra.",
    ],
  },
  {
    ...
    duration: "Instantâneo",
    description: [
      "Você invoca simultaneamente vida e morte dentro de uma esfera de 3m de raio centrada em um ponto no alcance. Cada criatura a sua escolha na area deve fazer um teste de resistência de constituição, sofrendo 2d6 de dano necrótico em uma falha ou metade em um sucesso. Vegetação não mágica na area murcha.",
    ...
    upcastDescription:
      "Quando você conjura esta magia usando um espaço de magia de 3º nível ou superior, o dano da magia aumenta em 1d6 para cada nível de espaço acima do 2º, e o numero de dados de vida que podem ser gastos aumenta em 1 para cada nível de espaço acima do 2º.",
  },
  {
    name: "Bolso de pulso",
    ...
    duration: "Concentração, até 1 hora",
    description: [
      "Você estala o pulso, fazendo com que um objeto em sua mão desapareça. O objeto, que apenas você pode estar segurando e que pode pesar no máximo 2,5 kg, é transportado para um espaço extradimensional, onde permanece durante a duração.",
