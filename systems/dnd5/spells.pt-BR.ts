...
export const SPELLS: Spell[] = [
  ...
  },
  {
    ...
    components: {
      v: true,
      s: true,
      m: "uma arma corpo a corpo valendo pelo menos 1sp",
    },
    duration: "1 rodada",
    description: [
    ...
    upcastDescription:
      "O dano dessa magia aumenta quando você atinge níveis mais altos. No 5° nível, o ataque corpo-a-corpo causa 1d8 de dano trovejante extra no alvo e o dano que o alvo sofre caso se mova aumenta para 2d8. Ambas as rolagens de dano aumentam em 1d8 no 11° nível (2d8 e 3d8) e no 17° nível (3d8 e 4d8).",
  },
  {
    ...
    duration: "8 horas",
    description: [
      "Você pega uma memória, uma ideia ou uma mensagem da sua mente e a transforma em um fio tangivel de energia brilhante chamado de fio de pensagemnto, que se mantem pela duração ou até você conjurar essa magia novamente. O fio de pensamento aparece em um espaço desocupado dentro de 1,5m de você como um objeto semisólido míudo que pode ser segurado e carregado como uma fita. Forá disso ele é estacionário",
      "Se você conjurar essa magia enquanto se concentra em uma magia ou habilidade que permite que você leia ou manipule os pensamentos de outros(Como detectar pensamentos ou modificar memória), você pode transformar os pensamentos ou memórias que leu em u fio, em vez de usar os seus.",
  ...
  },
  {
    ...
    duration: "1 rodada",
    description: [
      "Você brande a arma utilizada na conjuração dessa magia e faz um ataque corpo a corpo contra uma criatura até 1,5m de você. Em um acerto, o alvo sofre os efeitos normais do ataque da arma e você faz com que uma chama verde salte do alvo para uma criatura diferente a sua escolha que você possa ver a até 1,5m do primeiro alvo. A segunda criatura sofre dano de fogo igual ao seu modificador de atributo de conjuração.",
    ],
    upcastDescription:
      "O dano dessa magia aumenta quando você alcança certos níveis. No 5º nível, o ataque corpo a corpo provoca 1d8 de dano de fogo adicional se acertar, e o dano de fogo que a segunda criatura recebe aumenta para 1d8 + o modificador de seu atributo de conjuração. Ambos os danos aumentam em 1d8 no 11º nível (2d8 e 2d8) e novamente no 17º nível (3d8 e 3d8).",
  },
  {
    name: "Lufada",
    originalName: "Gust",
    ...
    description: [
      ...
      "-Uma criatura Média ou menor que você escolher deve ser bem sucedida em um teste de resistência de Força ou será empurrada até 1,5 metros de distância de você.",
  ...
  },
  {
    ...
    duration: "Instantâneo",
    description: [
      "Você faz com que um frio entorpecente se forme em uma criatura que você possa ver, dentro do alcance",
      "O alvo deve realizar um teste de resistência de Constituição. Se falhar na resistencia, o alvo sofre 1d6 de dano de frio e terá desvantágem na próxima jogada de ataque com arma que fizer antes do final do seu próximo turno",
    ],
    upcastDescription:
      "O dano da magia aumenta em 1d6 quando você alcança o 5° nível(2d6), 11 º nível (3d6) e 17º nível(4d6). ",
  },
  {
    name: "Criar Fogueira",
    ...
    duration: "Concentração, até 1 minuto",
    description: [
      "Você cria uma fogueira no solo em um ponto que você possa ver, dentro do alcance. Até a magia acabar, a fogueira preenche um cubo de 1,5 metros. Qualquer criatura no espaço da fogueira quando você a conjura deve ser bem sucedida num teste de resistência de Destreza ou sofrerá 1d8 de dano de fogo. Uma criatura também deve realizar o teste de resistência quando entrar no espaço da fogueira pela primeira vez em um turno, ou terminar seu turno nela.",
    ],
    upcastDescription:
      "O dano da magia aumenta em 1d8 quando você alcança o 5º nível (2d8), 11º nível (3d8) e 17° nível (4d8). ",
  },
  {
    name: "Infestação",
    ...
    upcastDescription:
      "O dano da magia aumenta em 1d6 quando você alcança 5] nível (2d6), 11º nível (3d16) e 17 º nível (4d6). ",
  },
  {
    ...
    duration: "Instantâneo",
    description: [
      "Você cria um chicote de energia elétrica que golpeia uma criatura a sua escolha a sua vista a até 4,5m de você. O alvo deve ser bem-sucedido em um teste de resistência de Força ou é puxado por até 3m em linha reta na sua direção, e então recebe 1d8 de dano elétrico se estiver a 1,5m de você.",
    ],
    upcastDescription:
      "O dano dessa magia aumenta em 1d8 quando você alcança o 5º nível (2d8), 11º nível (3d8), e 17º nível (4d8). ",
  },
  {
    ...
    duration: "1 minuto",
    description: [
      "Você toca em até 3 pedrinhas e as imbui com magia. Você ou outra criatura podem faazer um ataque com magia usando as pedras as arremessando ou atirando com uma funda. Se for arremessada, ela tem um alcance de 18m. Se o atacante não for você, ele adiciona o seu modificador de conjuração em vez do dele a jogada de ataque. Se atingir, o alvo sofre dano de concussão igual a 1d6+ seu modificador de habilidade de conjuração. Atingindo ou errando, a magia acaba para a pedra",
      "se você conjurar essa magia novamente, ela acaba em quaisquer pedras que ainda estivessem sendo afetadas",
    ],
    upcastDescription:
      "O dano dessa magia aumenta em 1d8 quando você alcança o 5º nível (2d8), 11º nível (3d8), e 17º nível (4d8). ",
  },
  {
    ...
    upcastDescription:
      "O dano deste truque aumenta em 1d6 quando você atinge certos níveis: 5º nível (2d6), 11º nível (3d6) e 17º nível (4d6). ",
  },
  {
    name: "Moldar Terra",
    ...
    duration: "Instantâneo ou 1 hora",
    description: [
      "-Se você atingir uma área de terra solta, poderá escavá-la instantaneamente, movê-la ao longo do solo e depositá-la a até 1,5 metro de distância. Este movimento não envolve força suficiente para causar danos.",
      ...
      "-Se a terra ou a pedra que você alvejar estiver no chão, você fará com que ela se torne um terreno difícil. Como alternativa, você pode fazer com que o solo se torne um terreno normal se já for um terreno difícil. Esta mudança dura 1 hora.",
  ...
  },
  {
    ...
    duration: "instantâneo",
    description: [
      "Você canaliza magia primordial para fazer com que seus dentes ou unhas se afiem, pronto para entregar um ataque corrosivo. Faça um ataque com magia corpo a corpo contra uma criatura a 1,5m de você. Em um acerto, o alvo recebe 1d10 de dano ácido. Depois de fazer o ataque, seus dentes ou unhas voltam ao normal.",
    ],
    upcastDescription:
      "O dano deste truque aumenta em 1d10 quando você atinge certos níveis: 5º nível (2d10), 11º nível (3d10) e 17º nível (4d10). ",
  },
  {
    ...
    upcastDescription:
      "O dano deste truque aumenta em 1d4 quando você atinge certos níveis: 5º nível (2d4), 11º nível (3d4) e 17º nível (4d4). ",
  },
  {
    name: "Moldar Água",
    ...
    duration: "Instantâneo ou 1 hora",
    description: [
      "-Você escolhe uma área de água que você possa ver, dentro do alcance, e que caiba num cubo de 1,5 metros. Você manipula-a de uma das seguintes maneiras:",
  ...
  },
  {
    ...
    duration: "Instantâneo",
    description: [
      "Você cria um circulo momentâneo de lâminas espectrais que giram ao seu redor. Todas as outras criaturas a até 1,5m de você devem ser bem sucedidas em um teste de resistência de destreza ou sofrem 1d6 de dano de energia",
    ],
    upcastDescription:
      "O dano deste truque aumenta em 1d6 quando você atinge certos níveis: 5º nível (2d6), 11º nível (3d6) e 17º nível (4d6). ",
  },
  {
    name: "Soar dos Mortos",
    ...
    duration: "Instantâneo",
    description: [
      "Você aponta para uma criatura que pode ver no alcance, e o agonizante som de um sino preenche o ar envolta dela por um momento. A criatura deve fazer um teste de resistencia de sabedoria, sofrendo 1d8 de dano necrotico em uma falha. Se a criatura não possuir todos os seus pontos de vida, ela sofre 1d12 em vez de 1d8",
    ],
    upcastDescription:
      "O dano deste truque aumenta em 1 dado quando você atinge certos níveis: 5º nível (2d8 ou 2d12), 11º nível (3d8 ou 3d12) e 17º nível (4d8 ou 4d12). ",
  },

  {
    ...
    duration: "Instantâneo",
    description: [
      "Você cria uma violenta explosão sonora, que pode ser ouvida a até 30 metros de distância. Cada criatura diferente de você a até 1,5 metros de você deve realizar um teste de resistência de Constituição. Se falhar na resistência, o alvo sofre 1d6 de dano trovejante.",
    ],
    upcastDescription:
      "O dano da magia aumenta em 1d6 quando você alcança o 5º nível (2d6), 11º nível (3d6) e 17° nível (4d6)",
  },
  {
