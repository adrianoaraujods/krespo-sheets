      ...
      <main>
        <Section className="grid gap-8 lg:grid-cols-2">
          <div className="flex flex-col justify-center">
            <Heading type="h1">{t("pages.home.hero.title")}</Heading>
            <Heading type="span" variant="subtitle">
        ...
        <Section className="grid gap-8 bg-muted/30 lg:grid-cols-[2fr,3fr]">
          ...
          <div className="flex flex-col items-start justify-center">
            <Heading type="h2">{t("pages.home.characters.title")}</Heading>
        ...
        <Section className="grid gap-8 lg:grid-cols-[3fr,2fr]">
          <div className="flex flex-col items-start justify-center">
            <Heading type="h2">{t("pages.home.kompendium.title")}</Heading>
        ...
        <Section className="grid gap-8 bg-muted/30 lg:grid-cols-[2fr,3fr]">
          ...
          <div className="flex flex-col items-start justify-center">
            <Heading type="h2">{t("pages.home.spells.title")}</Heading>
        ...
        <Section className="grid gap-8 lg:grid-cols-[3fr,2fr]">
          <div className="flex flex-col items-start justify-center">
            <Heading type="h2">{t("pages.home.systems.title")}</Heading>
